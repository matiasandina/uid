...
Since the `uid` package provides sample data that emulates the result of `read_raw_uid_csv`, and we can use it for the tutorial.
...
Data acquisition might generate `NA`s that survive downsampling. We included some of such gaps in the sample data.
